...
matlabbatch{2}.cfg_basicio.subsrefvar.subsreference{1}.subsindc = {4};
...
matlabbatch{3}.cfg_basicio.subsrefvar.subsreference{1}.subsindc = {4};
...
matlabbatch{4}.spm.stats.con.consess{1}.tcon.name(1).sname = 'Access part of MATLAB variable: val{4}';
...
matlabbatch{4}.spm.stats.con.consess{1}.tcon.convec(1).sname = 'Access part of MATLAB variable: val{4}';
